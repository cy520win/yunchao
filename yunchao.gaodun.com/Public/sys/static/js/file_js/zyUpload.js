	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					...
					url              : "admin.php?s=/Admin/SnsTopic/upheadnew",  	// 上传文件的路径
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
				    ...
				    html += '							<img class="upload_image" src="/Public/static/images/file_images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				// 处理不同类型文件代表的图标
				var fileImgSrc = "/Public/static/images/file_images/fileType/";
			...
			this.createCorePlug = function(){
				var params = {
					...
					onSuccess: function(file, response) {	
						...
						//$("#uploadInf").append("<p>上传成功，文件地址是：" +a.image.value + "</p>");	
						$("#input_file").append('<input name="image['+file.index+'][image][value]"  value="' + a.image.value + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][image][width]"  value="' + a.image.width + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][image][height]"  value="' + a.image.height + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][image][type]"  value="' + a.image.type + '" type="hidden" />');
						
						$("#input_file").append('<input name="image['+file.index+'][thumb_image][value]"  value="' + a.thumb_image.value + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][thumb_image][width]"  value="' + a.thumb_image.width + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][thumb_image][height]"  value="' + a.thumb_image.height + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][thumb_image][type]"  value="' + a.thumb_image.type + '" type="hidden" />');

						
						$("#input_file").append('<input name="image['+file.index+'][icon_image][value]"  value="' + a.icon_image.value + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][icon_image][width]"  value="' + a.icon_image.width + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][icon_image][height]"  value="' + a.icon_image.height + '" type="hidden" />');
						$("#input_file").append('<input name="image['+file.index+'][icon_image][type]"  value="' + a.icon_image.type + '" type="hidden" />');

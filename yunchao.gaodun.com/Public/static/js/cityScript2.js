...
citySelector.hotCity = ["北京", "上海", "深圳", "广州","天津","苏州","重庆","南京","杭州","大连","成都","武汉"];
...
citySelector.template = '<div class="city-box" id="js_cityBox"><div class="prov-city" id="js_provCity"><span class="blue_line"><span><p>热门城市</p><span class="blue_line"><span><ul>' + citySelector.hotCityhtmls + '</ul></div><div class="provence"><div>选择省份</div><div><ul id="js_provList">' + citySelector.provHtmls + '</ul></div></div></div>';

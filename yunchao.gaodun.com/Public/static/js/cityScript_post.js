...
citySelector.cityInit = function (input,local) {
    ...
    citySelector.template = '<div class="city-box" id="js_cityBox"><img src="/Public/static/images/del_city.png" alt="" class="del-city-box" onclick="delcity(this)"/><div class="prov-city" id="js_provCity"><div class="city-title-sp"></div><p class="city-title-sp2">热门城市</p><div class="city-title-sp"></div><ul>' + citySelector.hotCityhtmls + '</ul></div><div class="provence"><div class="city-title-sp"></div><p class="city-title-sp3 city-title-sp2">选择地点</p><div class="city-title-sp"></div><div><ul id="js_provList">' + citySelector.provHtmls + '</ul></div></div></div>';
